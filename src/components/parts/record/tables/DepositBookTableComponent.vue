    ...
    <table class="table table-sm table-bordered record-table">
      <thead class="book-title">
        <tr>
          <th colspan="7">
            {{
              depositBookData.depositKind + "(" + depositBookData.bankName + ")"
            }}
          </th>
        </tr>
      </thead>
      ...
      <tbody>
        <tr>
          ...
          <th></th>
          <th></th>
          <th class="text-right">{{ depositBookData.lastBalance }}</th>
        </tr>
        <tr v-for="(item, itemIndex) in depositBookData.items" :key="itemIndex">
        ...
        <tr>
          ...
          <th></th>
          <th class="text-right">
            {{ depositBookData.totalBalance | numberFormat }}
          </th>
        </tr>
      </tbody>
    </table>
